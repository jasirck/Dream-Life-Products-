/**
 * Detailed listing of proprietary software products.
 * Populates grid views on the SoftwarePage and the product details routing.
 */
export const softwareProducts = [
  ...
  },
  {
    ...
    image: "/software/club_logic.jpeg",
    youtube_link: "https://youtu.be/iSISL94vvW8?si=60YNXGCkSx5ODcDr"
  },
  {
    id: 6,
...
/**
 * Cards representing overarching development categories.
 * Renders large image-based navigational blocks on the Software solutions page.
 */
...
/**
 * Four core company pillars or tenets.
 * Drives the numerical glassmorphic indicator UI in the SoftwarePage standards section.
 */
export const pillars = [
  { num: "01", text: "Tailored Solutions for Every Client" },
  { num: "02", text: "Dedicated Commitment to Excellence" },
  { num: "03", text: "Authentic and Transparent Approach" },
  { num: "04", text: "Efficient and Timely Deliveries" }
];